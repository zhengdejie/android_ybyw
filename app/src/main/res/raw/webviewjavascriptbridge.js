;(function() {
	...
	function _doSend(message, responseCallback) {
		if (typeof console != 'undefined') console.log("responseCallback:"+responseCallback);
		if (responseCallback) {
			var callbackId = 'cb_'+(uniqueId++)+'_'+new Date().getTime();
			responseCallbacks[callbackId] = responseCallback;
			message['callbackId'] = callbackId;
		}
		if (typeof console != 'undefined') console.log("sending:"+JSON.stringify(message));
		_WebViewJavascriptBridge._handleMessageFromJs(message.data||null,message.responseId||null,
		message.responseData||null,message.callbackId||null,message.handlerName||null,JSON.stringify(message));
	}

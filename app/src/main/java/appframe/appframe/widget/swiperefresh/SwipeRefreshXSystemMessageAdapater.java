 ...
 */
public class SwipeRefreshXSystemMessageAdapater extends BaseAdapter {
    Context context;
    LayoutInflater layoutInflater;
    List<PushMessage> pushMessages ;

    public SwipeRefreshXSystemMessageAdapater(Context context,List<PushMessage> pushMessages)
    {

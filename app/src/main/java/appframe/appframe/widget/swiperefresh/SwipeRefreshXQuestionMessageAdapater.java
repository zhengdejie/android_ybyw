 ...
 */
public class SwipeRefreshXQuestionMessageAdapater extends BaseAdapter {
    Context context;
    LayoutInflater layoutInflater;
    List<PushMessage> pushMessages ;

    public SwipeRefreshXQuestionMessageAdapater(Context context,List<PushMessage> pushMessages)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            convertView = layoutInflater
                    .inflate(R.layout.swiperefreshx_questionmessage, null);

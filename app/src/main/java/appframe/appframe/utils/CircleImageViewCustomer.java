...
public class CircleImageViewCustomer extends com.android.volley.toolbox.NetworkImageView {
    ...
    public CircleImageViewCustomer(Context context) {
        super(context);

        init();
    }

    public CircleImageViewCustomer(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleImageViewCustomer(Context context, AttributeSet attrs, int defStyle) {

...
import appframe.appframe.activity.RelativenetActivity;
...
//                Toast.makeText(fragment.getActivity(),userId,Toast.LENGTH_SHORT).show();
                Intent intent = new Intent();
                Bundle bundle = new Bundle();
                intent.setClass(fragment.getActivity(), FriendsInfoActivity.class);
                UserBrief ub = new UserBrief();
                ub.setId(Integer.parseInt(userId));
                bundle.clear();

 ...
 */
public class MyRequireActivity extends BaseActivity implements View.OnClickListener {
...
//        initdata();
    ...
    protected void onResume() {
        super.onResume();
        initdata();
        MobclickAgent.onPageStart("我的求助页"); //统计页面(仅有Activity的应用中SDK自动调用，不需要单独写。"SplashScreen"为页面名称，可自定义)
    ...
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("我的求助页"); // （仅有Activity的应用中SDK自动调用，不需要单独写）保证 onPageEnd 在onPause 之前调用,因为 onPause 中会保存信息。"SplashScreen"为页面名称，可自定义
    ...
    public void init()
    {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(MyRequireActivity.this, OrderDetailsActivity.class);
    ...
    public void initdata()
    {
        ...
        Http.request(MyRequireActivity.this, API.GET_SELFORDER, new Object[]{Http.getURL(map)},
                new Http.RequestListener<List<OrderDetails>>() {
                    @Override
                    public void onSuccess(List<OrderDetails> result) {
                        super.onSuccess(result);
                        progress_bar.setVisibility(View.GONE);
                        swipeRefreshXMyMissionAdapater = new SwipeRefreshXMyMissionAdapater(MyRequireActivity.this, result);

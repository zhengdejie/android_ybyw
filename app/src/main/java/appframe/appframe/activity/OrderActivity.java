...
//    private static final String TYPE_ACTIVITY = "活动";
    ...
    TextView tv_city,tv_action,tv_require,tv_recommand,tv_question,tv_empty,tb_back;
    ...
    private OrderActivity.DropdownButtonsController dropdownButtonsController = new OrderActivity.DropdownButtonsController();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CODE_PICK_CITY && resultCode == RESULT_OK){
            if (data != null){
                ...
                SharedPreferences.Editor e = getSharedPreferences("Location", Context.MODE_PRIVATE).edit();
                e.remove("City");
...
//        tv_action = (TextView)findViewById(R.id.tv_action);
        ...
        question_tabs = (LinearLayout)findViewById(R.id.question_tabs);
        ...
        BaiduLocation baiduLocation = new BaiduLocation(OrderActivity.this,new OrderActivity.MyLocationListener());
        ...
        rl_city.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(new Intent(OrderActivity.this, CityPickerActivity.class),
...
//            @Override
//            public void onClick(View v) {
//                new OrderActivity.PopupWindows(OrderActivity.this, tv_action);
//            }
//        });
        tv_require.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tv_require.setTextColor(getResources().getColor(R.color.blue));
                ...
                Http.request(OrderActivity.this, API.GET_ORDER, new Object[]{Http.getURL(map)}, new Http.RequestListener<OrderDetailAndCount>() {
                    @Override
                    public void onSuccess(OrderDetailAndCount result) {
                        ...
                        if (result != null) {
                            ...
                            if (hasTopOrder()) {
                                ...
                                hasTopAdapater = new SwipeRefreshXOrderAdapater(OrderActivity.this, list_OD, AppConfig.ORDERSTATUS_MAIN, true, Type);
                                listView.setAdapter(hasTopAdapater);
                                tv_empty.setVisibility(View.GONE);

                            } else {
                                hasnotTopAdapater = new SwipeRefreshXOrderAdapater(OrderActivity.this, result.getOrderList(), AppConfig.ORDERSTATUS_MAIN, false, Type);
                            ...
                            if (hasTopOrder()) {
                                ...
                                od.add(topOrder);
                                hasTopAdapater = new SwipeRefreshXOrderAdapater(OrderActivity.this, od, AppConfig.ORDERSTATUS_MAIN, true);
                                listView.setAdapter(hasTopAdapater);
                                tv_empty.setVisibility(View.GONE);

                            } else {
                                hasnotTopAdapater = new SwipeRefreshXOrderAdapater(OrderActivity.this, null, AppConfig.ORDERSTATUS_MAIN, false);
                                listView.setAdapter(hasnotTopAdapater);
        ...
        tv_recommand.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tv_recommand.setTextColor(getResources().getColor(R.color.blue));
                tv_question.setBackgroundResource(R.drawable.titlebar_order_right_unselected);
                tv_question.setTextColor(Color.rgb(255, 255, 255));
                Map<String, String> map = new HashMap<String, String>();
                map.put("Page", "1");
        ...
        tv_question.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tv_question.setTextColor(getResources().getColor(R.color.blue));
                Map<String, String> map = new HashMap<String, String>();
                map.put("Page", "1");
                map.put("Size", String.valueOf(AppConfig.ORDER_SIZE));
                ...
                Http.request(OrderActivity.this, API.GET_QUESTION, new Object[]{Http.getURL(map)}, new Http.RequestListener<List<Question>>() {
                    @Override
                    public void onSuccess(List<Question> result) {
                        ...
                        progress_bar.setVisibility(View.GONE);
                        if (result != null) {
                            swipeRefreshXQuestionAdapater = new SwipeRefreshXQuestionAdapater(OrderActivity.this,result);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(Type == 3)
                {
                    intent.setClass(OrderActivity.this, QuestionDetailsActivity.class);
...
//                                Toast.makeText(getActivity(), "没有更多信息", Toast.LENGTH_SHORT).show();
        ...
        chooseMulti = (DropdownButton) findViewById(R.id.chooseMulti);
        chooseMoney = (DropdownButton) findViewById(R.id.chooseMoney);
        chooseSelect = (DropdownButton) findViewById(R.id.chooseSelect);
        chooseQuestionMoney = (DropdownButton) findViewById(R.id.chooseQuestionMoney);
        chooseQuestionStatus = (DropdownButton) findViewById(R.id.chooseQuestionStatus);
        chooseQuestionSelect = (DropdownButton) findViewById(R.id.chooseQuestionSelect);
        dropdownType = (DropdownListView) findViewById(R.id.dropdownType);
        dropdownMulti = (DropdownListView) findViewById(R.id.dropdownMulti);
        dropdownMoney = (DropdownListView) findViewById(R.id.dropdownMoney);
        dropdownSelect = (DropdownListView) findViewById(R.id.dropdownSelect);
        dropdownQeustionMoney = (DropdownListView) findViewById(R.id.dropdownQeustionMoney);
        dropdownQuestionStatus = (DropdownListView) findViewById(R.id.dropdownQuestionStatus);
        dropdownQuestionSelect = (DropdownListView) findViewById(R.id.dropdownQuestionSelect);

        dropdown_in = AnimationUtils.loadAnimation(OrderActivity.this, R.anim.dropdown_in);
        dropdown_out = AnimationUtils.loadAnimation(OrderActivity.this,R.anim.dropdown_out);
        dropdown_mask_out = AnimationUtils.loadAnimation(OrderActivity.this,R.anim.dropdown_mask_out);
...
//                        }
            ...
            else if (view == dropdownQeustionMoney || view == dropdownQuestionSelect || view == dropdownQuestionStatus)
            {
                ...
                Http.request(OrderActivity.this, API.GET_QUESTION, new Object[]{Http.getURL(questionMap)}, new Http.RequestListener<List<Question>>() {
                    @Override
                    public void onSuccess(List<Question> result) {
                        super.onSuccess(result);
        ...
        void init() {
            ...
            dropdownType.bind(datasetType, chooseType, OrderActivity.DropdownButtonsController.this, ID_TYPE_ALL,0);
...
//            });
            //全部分类
            Http.request(OrderActivity.this, API.GET_ORDERCATEGORY, new Http.RequestListener<List<OrderCategory>>() {
                @Override
                public void onSuccess(List<OrderCategory> result) {
                    super.onSuccess(result);
                    for (OrderCategory orderCategory : result) {
...
//                    .findViewById(R.id.item_popupwindows_send_recommand_order);
            ...
            btn_addfriends.setOnClickListener(new View.OnClickListener()
            {
                public void onClick(View v)
                {
                    Intent intent = new Intent(OrderActivity.this, AddFriendsActivity.class);
                    startActivity(intent);
                    dismiss();
                }
            });
...
//                String compareCity = locationCity;
                                ...
                                .setPositiveButton("切换",
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog,
                                                                int which) {
                                                SharedPreferences.Editor e = OrderActivity.this.getSharedPreferences("Location", Context.MODE_PRIVATE).edit();
                                                e.remove("City");
    ...
    public void onResume() {
        ...
        MobclickAgent.onResume(OrderActivity.this);          //统计时长
    ...
    public void onPause() {
        ...
        MobclickAgent.onPause(OrderActivity.this);
    }
}
